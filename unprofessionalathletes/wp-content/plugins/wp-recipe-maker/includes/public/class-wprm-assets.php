...
class WPRM_Assets {
	...
	public static function enqueue_admin() {
		...
		$wprm_admin = array(
			'wprm_url' => WPRM_URL,
			'ajax_url' => admin_url( 'admin-ajax.php' ),
			'manage_url' => admin_url( 'admin.php?page=wprecipemaker' ),
			'nonce' => wp_create_nonce( 'wprm' ),
			'api_nonce' => wp_create_nonce( 'wp_rest' ),
			'endpoints' => array(
				...
				'utilities' => get_rest_url( null, 'wp-recipe-maker/v1/utilities' ),
			),
			'eol' => PHP_EOL,
	...
	public static function get_custom_css( $type = 'recipe' ) {
		...
		$output .= ' .comment-form-wprm-rating .wprm-rating-star.rated svg polygon { fill: ' . WPRM_Settings::get( 'template_color_comment_rating' ) . '; }';
