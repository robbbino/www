 ...
 * @subpackage WP_Recipe_Maker/templates/recipe/legacy/clean
 */
...
<div class="wprm-recipe wprm-recipe-clean">
	...
	<div class="wprm-recipe-details-container wprm-recipe-times-container">
		...
		<div class="wprm-recipe-custom-time-container">
			<span class="wprm-recipe-details-name wprm-recipe-custom-time-name"><?php echo $recipe->custom_time_label(); ?></span> <?php echo $recipe->custom_time_formatted(); ?>
		</div>
